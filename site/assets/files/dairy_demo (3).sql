...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 12 2026 г., 03:07
...
INSERT INTO `users` (`id`, `login`, `password_hash`, `role`, `failed_attempts`, `is_locked`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin', 'admin', 0, 0, '2026-02-12 02:04:01', '2026-02-12 02:04:01'),
(2, 'User', 'user', 'user', 0, 0, '2026-02-12 02:07:19', '2026-02-12 02:07:19');
